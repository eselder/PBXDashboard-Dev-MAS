...
export class TvComponent {
  ...
  getListOfExtensions() {
    ...
    this.extensions.forEach(e => {
      ...
      else if ((s < 15 || (s < 45 && s > 30)) && (e.firstName == "Javier" ||  
      e.firstName == "Yariza" ||
      e.firstName == "Dilaila" ||
      e.firstName == "Rocio"  ||
      e.firstName == "Patricia" || 
      e.firstName == "Yadira" || 
      e.firstName == "Paola" ||
      e.firstName == "Julia" ||
      e.firstName == "Hilda" ||
      ...
      else if (((s >= 15 && s <= 30 ) || (s >= 45)) && (e.firstName == "Hilaria" || 
      e.firstName == "Elizabeth" ||
      e.firstName == "Armando"  ||
      e.firstName == "Alejandro" ||
      e.firstName == "Monica" || 
      e.firstName == "Rosarie" || 
      e.firstName == "Kim" ||
      e.firstName == "Ana" ||
      e.firstName == "Michelle" || 
      e.firstName == "Noelia"
       ))
      {
      }
  ...
  getExtensionStatus(ext: Extension) {
    this.extensionStatuses.forEach(es => {
      if (es.ID == ext.number) {
        ...
        if (ext.subStatus.length > 9) {
          ext.subStatus = ext.subStatus.slice(0, 9) + "...";
        }
      }
    });
  }
  ...
  getStatusClass(ext: Extension) {
    this.extensionStatuses.forEach(es => {
      if (es.ID == ext.number) {
        if (es.Status == "idle") {
          ext.extensionClass = "bg-primary";
          ext.glyphiconClass = "fas fa-user-check";
          return true;
        }
        else if (es.Status == "away") {
          ext.extensionClass = "bg-secondary";
